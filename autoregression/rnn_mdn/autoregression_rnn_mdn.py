"""
same as autoregression_rnn.py but with a mixture density network as last layer
"""
...
mu, sigma, alpha = autoreg(test_input)
...
def mdn_loss(y, mu, sigma, alpha):
    ...
    #normal = Normal(mu, sigma+1+1e-7)
    normal = Normal(mu, sigma+1e-7)
